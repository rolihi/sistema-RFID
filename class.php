    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                ...
                <h1 class="mb-4">Clases para tus hij@s</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">El dibujo es una forma de expresión gráfica que consiste en plasmar imágenes sobre un espacio plano a través de distintos tipos de instrumentos</p>
                        </div>
                        <div class="card-footer bg-transparent py-4 px-5">
                            <div class="row border-bottom">
                                <div class="col-6 py-1 text-right border-right"><strong>Edad de las niñ@s</strong></div>
                                <div class="col-6 py-1">5 - 17 años</div>
                            </div>
                            <div class="row border-bottom">
                                <div class="col-6 py-1 text-right border-right"><strong>Cupos aula</strong></div>
                                <div class="col-6 py-1">40 Cupos</div>
                            </div>
                            <div class="row border-bottom">
                                <div class="col-6 py-1 text-right border-right"><strong>Horario de clases</strong></div>
                                <div class="col-6 py-1">08:00 - 17:00</div>
                            </div>
                            <div class="row">
                                <div class="col-6 py-1 text-right border-right"><strong>Cuota de matrícula</strong></div>
                                <div class="col-6 py-1">Patrocinio</div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">El aprendizaje de otros idiomas permite enriquecer la vida, experimentar nuevas ideas, ejercitar la mente, beneficiarse de la diversidad</p>
                        </div>
                        <div class="card-footer bg-transparent py-4 px-5">
                            <div class="row border-bottom">
                                <div class="col-6 py-1 text-right border-right"><strong>Edad de las niñ@s</strong></div>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">La ciencia básica, investigación básica o investigación fundamental, es la ciencia o investigación que se lleva a cabo sin fines prácticos</p>
                        </div>
                        <div class="card-footer bg-transparent py-4 px-5">
                            <div class="row border-bottom">
                                <div class="col-6 py-1 text-right border-right"><strong>Edad de las niñ@s</strong></div>
