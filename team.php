...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <p class="section-title px-5"><span class="px-2">Plantel Docente</span></p>
                <h1 class="mb-4">Conoce a Nuestras Docentes</h1>
            </div>
            <div class="row">
    ...
    <div class="container-fluid py-5">
        <div class="container p-0">
            <div class="text-center pb-2">
                <p class="section-title px-5"><span class="px-2">Comentarios</span></p>
                <h1 class="mb-4">¡Comentarios de los padres!</h1>
            </div>
